...
def run(context):
    ...
    try:
        ...
        if not isinstance(design, adsk.fusion.Design):
            ui.messageBox("请先打开 Fusion 设计文件。")
            return
        ...
        # Axis = X
        # O-ring: 20mm OD / 14mm ID / 3mm width
        ...
        # M2 nut: AF 4.0mm, thickness 1.35-1.6mm
        nut_slot_sx = 5.4
        nut_slot_sy = 1.75
        nut_slot_sz = 4.1
        ...
        # Top slot opens from +X side
        nut_slot_x_top = 0.3

        # Bottom slot opens from -X side
        ...
        nut_slot_bottom = create_box_center(
            comp,
            "Cut_Bottom_M2_Nut_Slot_Open_NegX",
            nut_slot_x_bottom,
            nut_slot_y_bottom,
            0,
            nut_slot_sx,
