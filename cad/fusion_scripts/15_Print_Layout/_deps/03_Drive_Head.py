...
# Keep the proven assembly reference height so the movable platform retains its thickness.
...
def create_o_ring_roller(comp, center_x, center_y, center_z):
    ...
    core = create_cylinder_x_center(
        comp,
        '03_15_roller_hub_groove_root_16p8',
        center_x,
        center_y,
        center_z,
        groove_root_dia,
    ...
    hub.name = '03_18_printed_flat_rubber_hub_reference'
    ...
    nut_slot_top = create_box_center(
        comp,
        'cut_roller_top_m2_nut_through_slot',
    ...
    nut_slot_bottom = create_box_center(
        comp,
        'cut_roller_bottom_m2_nut_through_slot',
    ...
    hub.name = '03_19_printed_flat_rubber_hub_cut_reference'

    create_ring_x(
        comp,
        '03_20_flat_rubber_18p8od_16p8id_4w',
        center_x,
        center_y,
        center_z,
        flat_rubber_od,
