...
def add_04_wrap_limit(comp, root, ctx, p):
    ...
    if rib_z1 > rib_z0:
        ...
        outer_rib = box_z(
            comp,
            '04_Bottom_Ledge_Outer_Rib_FullWidth',
...
def add_05_corner_support(comp, design, ctx, p):
    ...
    bottom_extension = box_z(
        comp,
        '05_Bottom_Limit_Extension_Plate',
        (bottom_x0 + bottom_x1) / 2,
...
def run(context):
    ...
    try:
        ...
        silent_message_box('08 lock locator and limiters created.')
